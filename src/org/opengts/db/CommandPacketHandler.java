    ...
    extends AbstractClientPacketHandler
{
    ...
    **/
    ...
    public static void main(String argv[]) 
    {
        ...
        String cmdType   = RTConfig.getString("type","CONFIG");
        String cmdName   = RTConfig.getString("name","LocateNow");
        String cmdArgs[] = RTConfig.getStringArray("args",new String[] { "arg0", "arg1", "arg2", null, null });
        RTProperties cmdRTP = EncodeCommand(cmdType, cmdName, cmdArgs);
        Print.sysPrintln(cmdRTP.toString());
    }
