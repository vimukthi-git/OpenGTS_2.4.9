...
// ----------------------------------------------------------------------------
    ...
    private static Code _codeArray[] = new Code[] {
        ...
        new Code(STATUS_TRACK_START        , "TRACK.START"  , I18N.getString(StatusCodes.class,"StatusCodes.track.start"     ,"Track_Start"     ), true ),
        new Code(STATUS_TRACK_LOCATION     , "TRACK.LOC"    , I18N.getString(StatusCodes.class,"StatusCodes.track.location"  ,"Track_Location"  )       ),
        new Code(STATUS_TRACK_STOP         , "TRACK.STOP"   , I18N.getString(StatusCodes.class,"StatusCodes.track.stop"      ,"Track_Stop"      ), true ),
        ...
        new Code(STATUS_GPS_RESTORED       , "GPS.RESTORED" , I18N.getString(StatusCodes.class,"StatusCodes.gpsRestored"     ,"GPS_Restored"    ), true ),
