    ...
    **/
            ...
            if (getTitle) {
                ...
                if (expTime > 0L) {
                    if (expTime <= now) {
                        ...
                        return EventData.getTimestampString(expTime, acct, bpl);
                    }
                } else {
    ...
    public static void main(String argv[])
    {
        ...
        if (RTConfig.hasProperty(ARG_REPORT)) {
          ...
          //String  rptFmt  = "{C:2}{0:-3} {C:+6}{1} {C:+21}{2:-6} {C:+9}{3}";
            String  rptFmt  = "{C:4}{0:-3} {C:+6}{1:-6} {C:+9}{2} {C:+21}{3}";
            opts++;
            try {
                int acctCount      = 0;
                ...
                for (String acctListID : acctList) {
                    ...
                    for (String devID : devIDList) {
                        ...
                        if (device != null) {
                            ...
                            Print.sysPrintln(StringTools.formatLine(rptFmt,
                                ...
                                (devActive? String.valueOf(devCntActiv) : "--"),
                                devID,
                                devDesc));
                    ...
                    Print.sysPrintln(StringTools.formatLine(rptFmt,
                        "", "-------"                  , ""            , ""));
                    Print.sysPrintln(StringTools.formatLine(rptFmt,
                        "", String.valueOf(devCntActiv), "Active Count", ""));
                    Print.sysPrintln("");
